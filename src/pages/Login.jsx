...
export default function ZeptoLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center lg:p-5">
      <div
        className="flex max-w-3xl w-full lg:rounded-3xl overflow-hidden shadow-2xl lg:flex-row flex-col"
        style={{
      ...
      >
        ...
        >
          {/* Close Button - Show on mobile */}
          <div className="lg:hidden mb-6">
            <button
              onClick={() => navigate("/")}   // ✅ Home page redirect
